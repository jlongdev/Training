...
class Blockchain(object):
    ...
    def new_block(self, proof, previous_hash=None):
        ...
        # Reset the currentlist of transaction
    ...
    def new_transaction(self, sender, recipient, amount):
        # Adds a new transactiontot he list of transactions
        """
    ...
    def hash(block):
        ...
        Creates a SHA-256 hash of of Block
        :param block: <dict> Block
        :return: <str>

        """

        # We must make sure that the Dictionary is Ordered, or we'll have inconsistent hash
